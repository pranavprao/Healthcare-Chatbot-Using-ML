...
training_dataset = pd.read_csv('C:\\Users\\user\\Desktop\Health-Care-Chat-Bot-master\\Health-Care-Chat-Bot-master\\Training.csv')
test_dataset = pd.read_csv('C:\\Users\\user\\Desktop\Health-Care-Chat-Bot-master\\Health-Care-Chat-Bot-master\\Testing.csv')
...
doc_dataset = pd.read_csv('C:\\Users\\user\\Desktop\Health-Care-Chat-Bot-master\\Health-Care-Chat-Bot-master\\doctors_dataset.csv', names = ['Name', 'Description'])
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="KUSHAL MG", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="VARUN R", bg="RoyalBlue2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="PRANAV P RAO", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam4=Label(self, text="MANOHAR SN", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam4.pack()
        self.lblTeam5=Label(self, text="NAGSHARAN A", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam5.pack()
